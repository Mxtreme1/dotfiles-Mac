alias c="clear"
alias convert="
bash ../convert4.sh -A 25424004 -e:m4b -D  '${title//[.:]}' -F '${title//[.:]}'"
...
#alias mtex="python3 $DOTFILES_REPOSITORY_PATH/tex_makefile.py"
alias mtex="cp $DOTFILES_REPOSITORY_PATH/Makefile ."
...
alias ba="cs $HOME/Documents/Mathematik/7-Semester/Thesis/Bernsteins-Theorem"
alias cv="cs $HOME/Documents/CV-German"
...
alias zz="nvim $HOME/.zshrc && zsh"
alias ff="nvim $HOME/.zsh/functions.zsh && zsh"
alias aa="nvim $HOME/.zsh/aliases.zsh && zsh"
alias ii="nvim $HOME/.i3/config"
